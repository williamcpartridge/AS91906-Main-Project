...
class TileSpawn():
    def __init__(self, cell_count_x, cell_count_y, cell_width, cell_height, canvas):
        if cell_count_x >= 0:
    ...
    def spawn_tiles(self, cell_cx, cell_cy, canvas):
        self._canvas = canvas
            ...
            for y in range(self._cell_count_y):
                if y % 2 == 0:
                    ...
                    if x % 2 == 0:
                        ...
                        self._tile_surf.fill(self._LIGHT_GREEN)
                self._canvas.blit(self._tile_surf, (x*self._cell_width, y*self._cell_height))
